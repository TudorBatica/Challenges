...
import 'application/challenges_list/challenges_list_cubit.dart' as _i28;
...
import 'domain/challenge/challenge_repository.dart' as _i26;
...
import 'infrastructure/challenge/firestore_challenge_info_repository.dart'
    as _i22;
import 'infrastructure/challenge/firestore_challenge_repository.dart' as _i27;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i26.ChallengeRepository>(() =>
      _i27.FirestoreChallengeRepository(
          get<_i21.FirestoreCrudRepository<_i7.ChallengeInfo>>(),
          get<_i21.FirestoreCrudRepository<_i9.ChallengeTask>>()));
  gh.factory<_i28.ChallengesListCubit>(
      () => _i28.ChallengesListCubit(get<_i26.ChallengeRepository>()));
  gh.factory<_i29.NewChallengeCubit>(() => _i29.NewChallengeCubit(
      get<_i26.ChallengeRepository>(), get<_i19.ChallengeStorageRepository>()));
  return get;
}
