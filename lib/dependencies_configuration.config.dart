...
import 'application/common/app_cubit.dart' as _i24;
...
import 'domain/challenge/challenge_repository.dart' as _i25;
...
import 'infrastructure/challenge/firestore_challenge_info_repository.dart'
    as _i20;
import 'infrastructure/challenge/firestore_challenge_repository.dart' as _i26;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i24.AppCubit>(
      () => _i24.AppCubit(get<_i17.AuthenticationRepository>()));
  gh.lazySingleton<_i25.ChallengeRepository>(() =>
      _i26.FirestoreChallengeRepository(
          get<_i19.FirestoreCrudRepository<_i7.ChallengeInfo>>(),
          get<_i19.FirestoreCrudRepository<_i9.ChallengeTask>>()));
  gh.factory<_i27.NewChallengeCubit>(
      () => _i27.NewChallengeCubit(get<_i25.ChallengeRepository>()));
  return get;
}
